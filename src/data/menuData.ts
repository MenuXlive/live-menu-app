  ...
  categories: [
    {
      ...
      items: [
        ...
        { name: "Paneer Pakoda", price: "₹240", description: "Cottage cheese cubes in spiced gram flour coating", isBestSeller: true },
        { name: "Veg Cutlet", price: "₹160", description: "Hand-pressed mixed vegetable patties, herb-crusted" },
        { name: "Cheese Pakoda", price: "₹240", description: "Melting cheese encased in crispy golden batter", isBestSeller: true },
        { name: "Cheese Balls", price: "₹250", description: "Creamy cheese spheres with a crunchy breadcrumb shell" },
        { name: "French Fries", price: "₹139", description: "Hand-cut potatoes, twice-fried for extra crispiness" },
        ...
        { name: "Peri Peri Fries", price: "₹220", description: "Spicy peri-peri seasoned crispy fries", isChefSpecial: true },
  ...
  categories: [
    {
      ...
      items: [
        ...
        { name: "Tuborg Can (500 ml)", price: "₹279", description: "Smooth Danish lager in convenient can" },
      ],
    },
    {
      ...
      icon: "🍺",
      items: [
        { name: "Corona Extra", price: "₹350", description: "Mexican lager, served with lime", isPremium: true },
        { name: "Hoegaarden", price: "₹400", description: "Belgian white beer with citrus notes" },
        { name: "Budweiser Magnum Strong", price: "₹299", description: "Bold & full-bodied with rich malt character" },
        { name: "Heineken", price: "₹299", description: "Iconic Dutch pilsner with balanced bitterness" },
        { name: "Budweiser Mild", price: "₹299", description: "Smooth American-style pale lager" },
        { name: "Carlsberg Smooth", price: "₹269", description: "Exceptionally smooth Scandinavian brew" },
